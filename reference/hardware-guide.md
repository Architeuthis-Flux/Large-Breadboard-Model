...
- **Single path** (`connect(a, b, duplicates=0)`): approximately **80 Ω**
- **Default `connect(a, b)`**: firmware stacks multiple parallel paths via `[routing] stack_paths`, reducing effective resistance to approximately **20–40 Ω**
- **Rail/supply connections**: firmware stacks even more aggressively; effective resistance can be **~20 Ω or less**
